...
export function TrustIndicatorsSection() {
    ...
    return (
        <section className="landing-section-alt py-8 md:py-10 lg:py-12">
            <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
                <div className="grid gap-8 lg:grid-cols-[1fr_1.2fr] lg:items-center lg:gap-12">
                    <RevealSection variant="slide-left">
                        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-gold">Platform trust</p>
                        <h2 className="mt-2 font-display text-2xl font-medium tracking-tight md:text-3xl lg:text-4xl">
                    ...
                    >
                        {trustPillars.map((pillar) => (
                            <div
                                key={pillar.title}
                                className="card-glow-hover flex gap-4 rounded-xl border border-border/60 bg-card p-4 shadow-elevation-1 md:p-5 dark:border-border/80 dark:bg-card"
                            >
