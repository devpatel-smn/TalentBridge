...
export function CTASection({ variant = 'default' }: CTASectionProps) {
            ...
            <RevealSection variant="slide-right">
                <section className="pb-20 md:pb-28">
                    <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
                        <div className="grid items-center gap-10 overflow-hidden rounded-2xl border border-border/60 bg-card lg:grid-cols-2">
                            ...
                            <div className="p-8 md:p-12 lg:p-14">
                                <div className="inline-flex items-center gap-2 rounded-md bg-secondary/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-wider text-secondary">
                                ...
                                <div className="mt-8 flex flex-wrap gap-3">
                                    <Button size="lg" asChild className="rounded-lg bg-secondary hover:bg-secondary/90">
                                    ...
                                    <Button size="lg" variant="outline" asChild className="rounded-lg">
                                        <Link to={PUBLIC_PATHS.register}>Create employer account</Link>
                                    </Button>
                                </div>
                            </div>
                        </div>
    ...
    return (
        <RevealSection variant="slide-left">
            <section className="pb-20 md:pb-28">
                <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
                    <div className="surface-navy grain-overlay relative overflow-hidden rounded-2xl px-8 py-14 md:px-14 md:py-20">
                        <div className="absolute right-0 top-0 h-full w-1/3 bg-gradient-to-l from-highlight/10 to-transparent" />
                        <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
                            <div>
                                <div className="inline-flex items-center gap-2 rounded-md border border-gold/30 bg-gold/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-wider text-gold">
                                    <Briefcase className="h-3.5 w-3.5" />
                                    For job seekers
                                </div>
                                <h2 className="mt-5 font-display text-3xl font-medium tracking-tight text-white md:text-4xl lg:text-[2.75rem]">
                                ...
                                <div className="mt-8 flex flex-wrap gap-3">
                                    ...
                                    <Button
                                        ...
                                        variant="outline"
                                        asChild
                                        className="rounded-lg border-white/20 bg-transparent text-white hover:bg-white/8 hover:text-white"
                                    >
                            ...
                            <div className="hidden rounded-xl border border-white/10 bg-white/5 p-8 lg:block">
                                ...
                                <p className="mt-2 text-sm text-white/50">Successful placements worldwide</p>
